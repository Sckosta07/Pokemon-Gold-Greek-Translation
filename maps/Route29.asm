...
CatchingTutorialBoxFullText:
	...
	para "Δεν ξέρεις τι θα"
	line "βγει από εκεί…"
	done

CatchingTutorialIntroText:
	text "Σε έχω δει πολλές"
	line "φορές. Πόσα"
...
Route29YoungsterText:
	...
	para "Αν είναι αδύναμα"
	line "και θέλουν χρόνο,"
...
Route29TeacherText:
	text "Βλέπεις λοφάκια;"
	line "Έχουν φόβο να"
	cont "πέσεις από αυτά."
...
MeetTuscanyText:
	text "TUSCANY: Πι-"
	line "στεύω πως είναι"

	para "η πρώτη φορά που"
	line "συναντιόμαστε;"

	para "Ασε με να"
	line "συστηθώ."

	para "Είμαι η TUSCANY"
	line "της Τρίτης."
	done
...
TuscanyGaveGiftText:
	...
	para "Δυναμώνει τις"
	line "κανονικές κινήσεις."

	para "Είμαι σίγουρη"
	line "πως θα έχει χρήση."
	done
...
TuscanyTuesdayText:
	...
	para "Η τον μικρό α-"
	line "δελφό, τον WESLEY;"

	para "Είμαι δεύτερη από"
	line "επτά παιδιά."
	done

TuscanyNotTuesdayText:
	text "TUSCANY: Σήμερα"
	line "δεν είναι Τρίτη."
	cont "Τι ατυχία…"
	done
