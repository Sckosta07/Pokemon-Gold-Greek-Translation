...
SSAquaCaptainExhaustingText:
	...
	para "Κουράστηκα να"
	line "διασκεδάζω αυτό"
	cont "το κοριτσάκι."
	done

SSAquaCaptainHowDoYouLikeText:
	text "Θα ήθελες βόλτα"
	line "στο S.S.AQUA;"
...
SSAquaGranddaughterWasPlayingMText:
	...
	para "με τον ΚΑΠΕΤΑΝΙΟ"
	line "και αυτό τον τύπο!"
	done

SSAquaGranddaughterHadFunText:
	text "Είχε πολύ"
	line "πλάκα παίζοντας!"
	done
...
TwinsMegandpeg2SeenText:
	...
	para "Δεν είναι ωραίο"
	line "να λες σε κύριες!"
	done
...
SupernerdShawnAfterBattleText:
	text "Βάζε τις σωστές"
	line "BALLS που κάνουν"
	cont "κάθε φορά."
	done
