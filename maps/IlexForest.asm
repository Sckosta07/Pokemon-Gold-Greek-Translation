...
IlexForestApprenticeIntroText:
	...
	para "Το FARFETCH'D"
	line "που ΚΟΒΕΙ δέντρα"

	para "για κάρβουνο"
	line "μου ξέφυγε."

	para "Δεν μπορώ να"
	line "πάω να ψάξω στο"
	cont "ΔΑΣΟΣ ILEX."

	para "Είναι τόσο μεγάλο,"
	line "και με τρομάζει…"
	done
...
IlexForestApprenticeAfterText:
	...
	para "Το #μον του"
	line "αφεντικού δεν με"
	cont "υπακούει γιατί"
	cont "δεν έχω ΕΜΒΛΗΜΑ."
	done

Text_ItsTheMissingPokemon:
	text "Είναι το χαμένο"
	line "#μον!"
	done
...
Text_CharcoalMasterOutro:
	...
	para "ΕΜΒΛΗΜΑ της"
	line "AZALEA για χρήση."
	done

Text_CharcoalMasterTalkAfter:
	text "Θέλεις να γίνεις"
	line "μαθητευόμενος"

	para "Καρβουνιάρης"
	line "μαζί μου;"

	para "Θα είσαι κορυφή"
	line "σε δέκα χρόνια!"
	done
...
Text_HeadbuttIntro:
	...
	para "Έχει πλάκα. Ορίστε"
	line "κάνε και εσύ!"
	done

Text_HeadbuttOutro:
	text "Κούνα δέντρα με"
	line "ΚΕΦΑΛΙΕΣ. Κάποιες"
	cont "φορές, κοιμισμένα"
	cont "#μον πέφτουν."
	done

IlexForestSignpostText:
	text "Το ΔΑΣΟΣ ILEX"
	line "είναι μεγάλο με"

	para "δέντρα που κρύ-"
	line "βουν τον ουρανό."

	para "Πρόσεχε για"
	line "αντικείμενα που"
	cont "πέφτουν."
	done
