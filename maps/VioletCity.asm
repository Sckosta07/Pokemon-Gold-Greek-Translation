...
Text_HereTeacherIAm:
	text "Εδώ, ο δάσκαλος"
	line "είμαι. Καλά πρά-"
	cont "γματα θα μάθεις!"
	done

VioletCityLassText:
	text "Φαντάσματα λένε"
	line "πως φάνηκαν στον"
	cont "ΠΥΡΓΟ ΦΥΤΩΝ."

	para "Λένε πως κανονικές"
	line "κινήσεις δεν"
...
VioletCitySuperNerdText:
	...
	para "θα είσαι έτοιμος"
	line "για ότι καλύτερο!"
	done
...
VioletCityGrampsText:
	...
	para "της VIOLET, είναι"
	line "καλός εκπαιδευτής!"
...
VioletCitySignText:
	...
	para "Η Πόλη Του Νοστα-"
	line "λγικού Αρώματος"
	done
