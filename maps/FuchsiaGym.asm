...
JanineText_DisappointYou:
	...
	para "Είμαι η αληθινή!"

	para "JANINE του FUCHSIA"
	line "GYM, εγώ είμαι!"
	done
...
JanineText_ToxicSpeech:
	...
	para "σταθερά βλάπτει"
	line "το HP του εχθρού."
	done
...
JanineText_ApplyMyself:
	...
	para "Θα γινω πιο καλή"
	line "και από τον Πατέρα"
	cont "και από εσένα!"
	done
...
LassLindaBeatenText:
	text "Ουχ… Έχασα…"
	line "Δεν είσαι χάλια…"
	done

LassLindaAfterText:
	text "Λοιπόν; Δεν ήταν"
	line "η μορφή μου καλή;"
	done
...
CamperBarryBeatenText:
	text "Η μορφή μου δεν"
	line "ήταν σωστή! Φτου!"
	done

CamperBarryAfterText:
	text "Έι, φίλε. Ήταν η"
	line "μορφή μου ωραία"
	cont "ή κάτι, ε;"
	done
