...
CameraGrunt2SeenText:
	text "Είναι η σειρά μου!"
	line "Δεν ξεφεύγεις!"
	done

CameraGrunt2BeatenText:
	text "Οι κάμερες είναι"
	line "στα αγάλματα"
	cont "#μον."

	para "Θα φαίνεσαι"
	line "μέχρι να πατήσεις"
	cont "κρυφό διακόπτη."
	done

ScientistJedSeenText:
	text "Εδω ήταν κάποτε"
	line "κρυψώνα νίντζα."

	para "Υπάρχουν παγίδες"
	line "που διώχνουν ει-"
	cont "σβολείς όπως εσύ."
	done
...
ScientistJedAfterBattleText:
	text "Εντάξει. Θα"
	line "σου πω μυστικό"
	cont "για την κρυψώνα."

	para "Το πράγμα στον"
	line "οροφο πάνω μας"
	cont "πλάκα αλλαγής."

	para "Αν πατήσεις πάνω,"
	line "θα πας πίσω"
...
TeamRocketBaseB1FSecretSwitchText:
	text "Κρυφός διακόπτης!"
	line "Καλύτερα πάτα τον."
	done
