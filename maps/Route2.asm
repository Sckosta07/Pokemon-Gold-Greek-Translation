...
BugCatcherRobAfterBattleText:
	text "Θα ψάξω για πιο"
	line "δυνατά έντομα"
	cont "#μον."
	done

BugCatcherEdSeenText:
	text "Αν πας στα ψηλά"
	line "γρασίδια φορώντας"
...
BugCatcherEdAfterBattleText:
	text "Είναι πολύ χάλια"
	line "όταν σε"
	cont "γρατζουνάνε."
	done

BugCatcherDougSeenText:
	text "Δεν αρέσουν στα"
	line "κορίτσια έντομα;"
	done
