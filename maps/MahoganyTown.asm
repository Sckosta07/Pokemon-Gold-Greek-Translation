...
RageCandyBarMerchantTryOneText:
	text "Γεια, γιόκα μου!"
	line "Βλέπω είσαι νέος"
	cont "στη MAHOGANY."

	para "Αφού είσαι νέος,"
	line "πρέπει να δοκιμά-"

	para "σεις το νόστιμο"
	line "ΓΛΥΚΟΟΡΓΗΣ!"

	para "Τώρα, θα γίνει"
	line "δικό σου μόνο για"
	cont "¥{d:MAHOGANYTOWN_RAGECANDYBAR_PRICE}! Θες ένα;"
	done
...
MahoganyTownLassText:
	text "Δες το μαγαζί της"
	line "γιαγιάς. Πουλάει"

	para "πράγματα που"
	line "δεν έχουν άλλοι."
	done

MahoganyTownSignText:
	text "ΠΟΛΗ MAHOGANY"

	para "Καλώς Ήρθατε στο"
	line "Σπίτι Των Νίντζα"
	done

MahoganyTownRagecandybarSignText:
	text "Καθώς βλέπετε"
	line "την MAHOGANY,"
	cont "Πάρτε ΓΛΥΚΟΟΡΓΗΣ!"
	done
