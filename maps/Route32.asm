...
Route32CooltrainerMText_UnusedSproutTower:
	...
	para "περιμένουν να"
	line "προπονείσαι εκεί."

	para "Είναι τα βασικά"
	line "για εκπ/τες. Τρέχα"
	cont "για τον ΠΥΡΓΟ!"
	done
...
Route32CooltrainerMText_HaveThisSeed:
	...
	para "Ως σουβενίρ της"
	line "ΠΟΛΗΣ VIOLET,"
	cont "πάρε αυτό."

	para "Αυξάνει τη"
	line "δύναμη κινήσεων"
	cont "γρασιδιού."
	done

Route32CooltrainerMText_ExperiencesShouldBeUseful:
	text "Η εμπειρία στην"
	line "ΠΟΛΗ VIOLET"

	para "θα φανεί χρήσιμη"
	line "στο ταξίδι σου."
	done
...
Route32UnusedFisher1AfterText: ; unreferenced
	text "Πως μπορεί ο"
	line "τύπος δίπλα μου"
	cont "να πιάνει τα καλά;"
	done
...
YoungsterGordonAfterText:
	text "Το γρασίδι είναι"
	line "γεμάτο ομορφιές."
	done

CamperRolandSeenText:
	text "Η μάτια σου…"
	line "Έχουν ενδιαφέρον."
	done
...
BirdKeeperPeterSeenText:
	text "Το ΕΜΒΛΗΜΑ! Είναι"
	line "στην ΠΟΛΗ VIOLET!"
...
BirdKeeperPeterAfterText:
	text "Θα προπονηθώ"
	line "ξανά στο GYM"
	cont "της ΠΟΛΗΣ VIOLET."
	done

Route32UnusedText: ; unreferenced
	text "Οι ψαράδες γελάνε"
	line "μαζί μου επειδή"
	cont "τους ενοχλώ…"
	done

Text_RoarIntro:
	text "ΓΡΟΟΟΟΑΡ!"
	line "ΟΛΟΙ ΦΕΥΓΟΥΝ ΟΤΑΝ"

	para "ΓΡΥΛΙΖΩ! ΜΑ"
	line "ΕΣΥ ΜΕ ΚΟΙΤΑΖΕΙΣ!"
...
Text_RoarOutro:
	...
	para "ΑΚΟΜΑ ΚΑΙ ΠΟΚΕΜΟΝ"
	line "ΤΡΕΧΟΥΝ ΜΕ ΑΥΤΟ!"
	done

MeetFriedaText:
	text "FRIEDA: Γιαχου!"
	line "Είναι Παρασκευή!"
...
FriedaGaveGiftText:
	...
	para "Θα σε σοκάρει"
	line "πόσο καλό κάνουν"
	cont "οι δηλητ. κινήσεις!"
	done

FriedaFridayText:
	text "FRIEDA: Χάιγια!"
	line "Τι μέρα σ'αρέσει;"

	para "Λατρεύω την Παρα-"
	line "σκευή! Σίγουρα!"
