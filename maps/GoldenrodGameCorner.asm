...
GoldenrodGameCornerPharmacistText:
	text "Πάντα παίζω σε"
	line "αυτή την μηχανή."

	para "Δίνει περισσότερα"
	line "από άλλες, νομίζω."
	done
...
GoldenrodGameCornerPokefanM1Text:
	...
	para "Είναι πιο πολύ"
	line "πρόκληση από"
	cont "αυτές της CELADON."
	done

GoldenrodGameCornerCooltrainerMText:
	text "Η ζωή έχει πλάκα."
	line "Θα παίξω μέχρι"
	cont "τέλους!"
	done
...
GoldenrodGameCornerPokefanFText:
	...
	para "Τις προτιμώ"
	line "από τις μηχανές"

	para "γιατί είναι πιο"
	line "εύκολο να νικάω."

	para "Μα η πληρωμή"
	line "είναι πιο χαμηλή."
	done

GoldenrodGameCornerCooltrainerFText:
	text "Δεν φεύγω"
	line "μέχρι να κερδίσω!"
	done
