...
CooltrainerfCarolSeenText:
	text "Προπονούμαι για να"
	line "γίνω ΠΡΩΤΑΘΛΗΤΗΣ!"
	done

CooltrainerfCarolBeatenText:
	text "Τι διαφορά έχουμε"
	line "εμείς οι δύο;"
	done
...
PokemaniacEthanAfterBattleText:
	text "Ωραία η LILY,"
	line "μα η MARY τέλεια!"

	para "Θελω να δω"
	line "τους σταθμούς"
	cont "ράδιο του JOHTO!"
	done
...
SailorStanlyAfterBattleText:
	text "Το να είσαι ναύτης"
	line "έχει να κάνει με"
	cont "τη φυσική δύναμη."
	cont "Κουράστηκα!"
	done
