...
BrunoScript_BrunoBeforeText:
	...
	para "Πάντα κάνω ακραία"
	line "προπόνηση επειδή"
	cont "πιστεύω στο"
	cont "ταλέντο μας."
	...
	para "Χμ; Δεν με"
	line "φοβάσαι. Φαίνεσαι"

	para "αποφασισμένος."
	line "Τέλειο για μάχες!"

	para "Έτοιμος, <PLAYER>;"
	line "Θα γονατίσεις στην"
