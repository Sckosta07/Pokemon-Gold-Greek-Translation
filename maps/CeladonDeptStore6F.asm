...
.MenuData:
	...
	db 4 ; items
	db "ΦΡΕΣΚΟ ΝΕΡΟ  ¥{d:CELADONDEPTSTORE6F_FRESH_WATER_PRICE}@"
	db "ΣΟΔΑ ΠΟΠ     ¥{d:CELADONDEPTSTORE6F_SODA_POP_PRICE}@"
	db "ΛΕΜΟΝΑΔΑ     ¥{d:CELADONDEPTSTORE6F_LEMONADE_PRICE}@"
	db "ΑΚΥΡΟ@"
...
CeladonVendingText:
	text "Αυτοματος πωλητής!"
	line "Ορίστε το μενού."
	done
