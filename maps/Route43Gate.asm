...
RocketText_TollFee:
	...
	para "Διόδια είναι ¥{d:ROUTE43GATE_TOLL}"
	line "για να περασεις."
	done

RocketText_ThankYou:
	text "Ευχαριστώ, κύριε!"
	done
...
OfficerText_FoundTM:
	text "Με κυνηγάνε από"
	line "το πόστο μου αυτοί"
	cont "οι τύποι."
