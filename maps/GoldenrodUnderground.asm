...
PokemaniacDonaldSeenText:
	text "Πιστεύω πως έχεις"
	line "σπάνια #μον"
	cont "μαζί σου."

	para "Άσε με να τα δω!"
	done

PokemaniacDonaldBeatenText:
	text "Γααχ! Έχασα!"
	line "Αυτό με τρελαίνει!"
	done

PokemaniacDonaldAfterBattleText:
	text "Έχεις ένα"
	line "#ντεξ; Ορίστε"
	cont "μια καλή συμβουλή!"

	para "Ο ΟΡΕΙΒΑΤΗΣ στο"
	line "ΔΡΟΜΟ 33, ANTHONY,"
	cont "είναι καλός τύπος."
...
GoldenrodUndergroundBasementKeyOpenedDoorText:
	text "Το ΚΛΕΙΔΙ ΒΑΣΗΣ"
	line "άνοιξε την πόρτα."
	done
...
GoldenrodUndergroundOlderHaircutBrotherOfferHaircutText:
	...
	para "Είμαι ο μεγάλος και"
	line "καλύτερος απο τους"
	cont "δυο ΚΟΜΩΤΕΣ."

	para "Θα κάνω τα"
	line "#μον σας όμορφα"
	cont "για ¥{d:GOLDENRODUNDERGROUND_OLDER_HAIRCUT_PRICE}."
...
GoldenrodUndergroundOlderHaircutBrotherOneHaircutADayText:
	text "Κάνω ένα κούρεμα"
	line "την ημέρα. Τελεί-"
	cont "ωσα για σήμερα."
	done

GoldenrodUndergroundYoungerHaircutBrotherOfferHaircutText:
	text "Καλως ηρθες στο"
	line "ΣΑΛΟΝΙ ΠΟΚΕΜΟΝ!"
...
GoldenrodUndergroundYoungerHaircutBrotherOneHaircutADayText:
	text "Κάνω μόνο ένα"
	line "κούρεμα την μέρα."

	para "Λυπάμαι, μα τε-"
	line "λείωσα για σήμερα."
	done
