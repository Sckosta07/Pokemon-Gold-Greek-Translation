...
OaksPKMNTalkName:     db "Ομιλία <PK><MN> του OAK@"
PokedexShowName:      db "Σόου #ντεξ@"
PokemonMusicName:     db "Μουσική #μον@"
LuckyChannelName:     db "Τυχερό Κανάλι@"
UnownStationName:     db "?????@"

PlacesAndPeopleName:  db "Μέρη & Κόσμος@"
LetsAllSingName:      db "Τραγουδήστε!@"
PokeFluteStationName: db "ΠΟΚΕ ΦΛΑΟΥΤΟ@"
