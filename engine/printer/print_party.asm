...
GBPrinterString_CheckingLink: next " ΤΣΕΚΑΡΕ LINK...@"
GBPrinterString_Transmitting: next "  ΜΕΤΑΔΟΣΗ...@"
GBPrinterString_Printing: next "    ΕΚΤΥΠΩΝΕΙ...@"
GBPrinterString_PrinterError1:
	db   " Σφάλμα 1"
	next ""
	next "Τσέκαρε το GAME BOY"
	next "Εκτυπωτή Manual."
	db   "@"
