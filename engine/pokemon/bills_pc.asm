...
PCString_ChooseaPKMN: db "Διάλεξε <PK><MN>.@"
PCString_WhatsUp: db "Τι λέει;@"
PCString_ReleasePKMN: db "Άφησε <PK><MN>;@"
PCString_MoveToWhere: db "Κούνα το που;@"
PCString_ItsYourLastPKMN: db "Είναι το τελευταίο!@"
PCString_TheresNoRoom: db "Δεν έχει χώρο!@"
PCString_NoMoreUsablePKMN: db "Μη χρήσιμα <PK><MN>!@"
PCString_RemoveMail: db "Αφαίρεση MAIL.@"
PCString_ReleasedPKMN: db "Άφησε <PK><MN>.@"
PCString_Bye: db "Αντίο,@"
PCString_Stored: db "Απόθεσε @"
PCString_Got: db "Πηρε @"
PCString_Non: db "Μη.@" ; unreferenced
PCString_BoxFull: db "Το ΚΟΥΤΙ γέμησε.@"
PCString_PartyFull: db "Η ομάδα γέμησε!@"
PCString_NoReleasingEGGS: db "Μη αφήσεις τα ΑΥΓΑ!@"
