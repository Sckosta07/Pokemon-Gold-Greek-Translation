...
.String_OaksPC:     db "ΚΑΘ.OAK PC@"
.String_HallOfFame: db "ΠΑΝΘΕΟΝ@"
.String_TurnOff:    db "ΣΒΗΣΕ@"
...
.WithdrawItem: db "ΠΑΡΕ ΑΝΤΙΚ.@"
.DepositItem:  db "ΔΩΣΕ ΑΝΤΙΚ.@"
.TossItem:     db "ΠΕΤΑΞΕ@"
.MailBox:      db "ΚΟΥΤΙ MAIL@"
.Decoration:   db "ΔΙΑΚΟΣΜΗΣΗ@"
.TurnOff:      db "ΣΒΗΣΕ@"
.LogOff:       db "ΒΓΕΣ@"
