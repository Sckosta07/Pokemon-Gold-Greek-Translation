...
Credits_NobOgasawara::        db "        SCKOSTA@"
...
Credits_Staff::               db "      #MON"                 ; "ポケットモンスター"
                            ...
                            ENDC
                            next "       STAFF@"
Credits_Director::            db "      ΔΙΕΥΘΥΝΤΗΣ@"            ; "エグゼクティブ　ディレクター@"
Credits_SubDirector::         db "   ΥΠΟΔΙΕΥΘΥΝΤΗΣ@"
Credits_Programmers::         db "  ΠΡΟΓΡΑΜΜΑΤΙΣΤΕΣ@"           ; "プログラム@"
Credits_GraphicsDirector::    db "  ΔΙΕΥΘ. ΓΡΑΦΙΚΩΝ@"        ; "グラフィック　ディレクター@"
Credits_MonsterDesign::       db "   ΣΧΕΔΙΟ MONSTER@"         ; "#　デザイン@"
Credits_GraphicsDesign::      db "  ΣΧΕΔΙΟ ΓΡΑΦΙΚΩΝ@"         ; "グラフィック　デザイン@"
Credits_Music::               db "   ΜΟΥΣΙΚΗ@"              ; "おんがく@"
Credits_SoundEffects::        db "   ΗΧΙΤΙΚΑ ΕΦΕ@"          ; "サウンド　エフェクト@"
Credits_GameDesign::          db "    GAME DESIGN@"           ; "ゲームデザイン@"
Credits_GameScenario::        db "   ΣΕΝΑΡΙΟ GAME@"          ; "シナりオ@"
Credits_ToolProgramming::     db "  TOOL PROGRAMMING@"        ; "ツール　プログラム@"
Credits_ParametricDesign::    db "  DESIGN ΠΑΡΑΜΕΤΡΩΝ@"        ; "パラメーター　せってい@"
Credits_ScriptDesign::        db "   SCRIPT DESIGN@"          ; "スクりプト　せってい@"
Credits_MapDataDesign::       db "  MAP DATA DESIGN@"         ; "マップデータ　せってい@"
Credits_MapDesign::           db "    DESIGN ΧΑΡΤΗ@"           ; "マップ　デザイン@"
Credits_ProductTesting::      db "  PRODUCT TESTING@"         ; "デバッグプレイ@"
Credits_SpecialThanks::       db "    ΕΥΧΑΡΙΣΤΙΕΣ@"         ; "スぺシャルサンクス@"
Credits_Producers::           db "     ΠΑΡΑΓΩΓΟΙ@"            ; "プロデューサー@"
Credits_ExecutiveProducer::   db "  ΕΚΤΕΛ. ΠΑΡΑΓΩΓΟΙ@"       ; "エグゼクティブ　プロデューサー@"
Credits_UsVersionStaff::      db "  US VERSION STAFF@"
Credits_UsCoordination::      db "  US ΣΥΝΤΟΝΙΣΜΟΣ@"
Credits_TextTranslation::     db " ΕΛΛΗΝΙΚΗ ΜΕΤΑΦΡΑΣΗ@"
